...
local function safeSetPrimaryCFrame(targetCharacter, targetCFrame)
...
refresh()
sliderRegistry[settingKey] = refresh
...
listFrame.Size = UDim2.new(1, 0, 0, 136)
...
if selectedTargetValue then
refreshTargetDisplay()
end

if states.fly and flyVelocity and flyGyro and humanoidRootPart then
